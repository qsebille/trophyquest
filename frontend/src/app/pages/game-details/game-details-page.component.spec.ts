...
describe('GameDetailsPageComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      .overrideComponent(GameDetailsPageComponent, {
        set: {
          providers: [
            {provide: GameDetailsStoreService, useValue: gameDetailsDataServiceMock},
            {provide: GameTrophyStoreService, useValue: gameTrophyDataServiceMock},
            {provide: GamePlayersStoreService, useValue: gamePlayersDataServiceMock},
          ],
        },
      })
      .compileComponents();
