...
from igdb.database import queries as data_queries, data as data_builder
...
def run_enricher(nb_game_to_match=50):
    ...
    pending_games = data_queries.select_psn_games_with_pending_match_status(nb_game_to_match)
    ...
    data_queries.insert_igdb_match(db_data)
